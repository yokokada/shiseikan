  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>ボタンを押すとジャーナリングの質問が出てきますので、ご自身のノートに書き込んでみてください。<br />ジャーナリングはスマホにメモをするのではなく、書く方が効果的と言われています。<br />質問は14問。ランダム表示されます。違う質問が良い場合はもう一度ボタンを押してください。<br />全て答えると何か起こるかも?!</p>
